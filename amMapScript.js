...
AmCharts.ready(function() 
{
	...
	*/
	...
	var dataProvider = {
		...
		images:[{latitude:41.0136, longitude:28.9550, svgPath:icon, color:"#B70000", scale:0.6, label:"Istanbul", labelShiftY:2, 
			zoomLevel: 4, zoomLongitude: 60, zoomLatitude: 39.1712, 
			...
			{latitude:41.9000, longitude:12.5000, svgPath:icon, color:"#B70000", scale:0.6, label:"Rome", labelShiftY:2,   
			zoomLevel: 4, zoomLongitude: 60, zoomLatitude: 39.1712, 
			...
			{latitude:39.9139, longitude:116.3917, svgPath:icon, color:"#B70000", scale:0.6, label:"Beijing", labelShiftY:2, 
			zoomLevel: 4, zoomLongitude: 60, zoomLatitude: 39.1712, 
			...
			{latitude:51.5072, longitude:0.1275, svgPath:icon, color:"#B70000", scale:0.9, label:"London", labelShiftY:2,
			zoomLevel: 4, zoomLongitude: 60, zoomLatitude: 39.1712, 
			...
			{latitude:50.0833, longitude:14.4167, svgPath:icon, color:"#B70000", scale:0.6, label:"Prague", labelShiftY:2 ,  
			zoomLevel: 4, zoomLongitude: 60, zoomLatitude: 39.1712, 
	...
	map.write("mapdiv");
	map.zoomToLongLat(3, 58.9550, 41.0136, 1);
