...
function home()
{
	window.location.replace("http://edward2.solent.ac.uk/~dspokes/Hackathon2015/");
}
function info()
{
	window.location.replace("http://edward2.solent.ac.uk/~dspokes/Hackathon2015/results.php?destination='Australia");
}
function init()
{
	  ...
	  <div class="container">
	    ...
	    <div>
	      <ul class="nav navbar-nav">
	        <li class="active"><a onClick='home()'>Home</a></li>
	        <li><a onClick='info()'>Info</a></li>
	      </ul>
	    </div>
	  </div>
	</nav>
...
<!-- Total Price for holiday -->
 ...
 <p>No public drinking nor smoking</p>
